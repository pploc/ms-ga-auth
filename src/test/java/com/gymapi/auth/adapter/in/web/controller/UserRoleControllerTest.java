...
class UserRoleControllerTest {
    ...
    void setUp() {
        ...
        testUserRole = new UserRole(UUID.randomUUID(), userId, roleId, UUID.randomUUID(), OffsetDateTime.now());
    }
    ...
    void getUserRolesWithPermissions_Success() throws Exception {
        RolesWithPermissions rolesWithPermissions = new RolesWithPermissions(userId, List.of("MEMBER"),
                List.of("booking:read"));
        com.gymapi.auth.adapter.in.web.dto.generated.RolesWithPermissionsResponse response = new com.gymapi.auth.adapter.in.web.dto.generated.RolesWithPermissionsResponse();
        ...
        mockMvc.perform(get("/auth/users/{userId}/roles/with-permissions", userId))
                .andExpect(status().isOk())
    ...
    void hasRole_Success() throws Exception {
        ...
        mockMvc.perform(get("/auth/users/{userId}/roles/{roleId}/check", userId, roleId))
                .andExpect(status().isOk())
