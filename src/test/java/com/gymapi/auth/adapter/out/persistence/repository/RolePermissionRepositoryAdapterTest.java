...
class RolePermissionRepositoryAdapterTest {
  ...
  @Mock private RolePermissionJpaRepository rolePermissionJpaRepository;

  @Mock private RoleJpaRepository roleJpaRepository;

  @Mock private PermissionJpaRepository permissionJpaRepository;

  @InjectMocks private RolePermissionRepositoryAdapter adapter;
  ...
  void findPermissionsByRoleId_Success() {
    ...
    given(rolePermissionJpaRepository.findByRole_Id(roleId)).willReturn(List.of(rp));
  ...
  void saveRolePermissions_Success() {
    ...
    verify(rolePermissionJpaRepository).deleteByRole_Id(roleId);
