...
public class RoleRepositoryAdapter implements RoleRepository {
    ...
    public Role save(Role role) {
        RoleEntity entity = mapper.mapToEntity(role);
    ...
    public Optional<Role> findById(UUID id) {
        return roleJpaRepository.findById(id).map(mapper::mapToDomain);
    }

    @Override
    public Optional<Role> findByName(String name) {
        return roleJpaRepository.findByName(name).map(mapper::mapToDomain);
    }
